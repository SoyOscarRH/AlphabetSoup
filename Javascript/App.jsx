...
export default class App extends React.Component {
  ...
  constructor(props) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const Sidenavs = M.Sidenav.init(Elements, {
        draggable: true,
        edge: "left"
      });
      ...
      <div>
        ...
        <header>
          ...
          <div className="navbar-fixed">
            <nav className="indigo darken-2">
              <div className="nav-wrapper container">
                {/*+++++++++++   NAME OF PAGE   ++++++++++++*/}
                <div
                  className="brand-logo white-text center"
          ...
          <ul id="SideMenu" className="sidenav">
            ...
            <li>
              <a className="subheader">General</a>
            </li>
            <li>
              <a
                className="waves-effect"
            ...
            <li>
              <a className="subheader">Personalización</a>
            </li>
            <li>
              <div className="row">
                <div className="input-field col s6 offset-s1">
                  <input
                    ...
                    onChange={e =>
                      this.setState({ TemporalBoardSize: e.target.value })
                    }
                  />
                  ...
                  <a
                    ...
                    onClick={() => {
                      ...
                      if (Number.isInteger(Value) && Value > 7 && Value < 21)
                        this.setState({
                          BoardSize: Number(this.state.TemporalBoardSize)
                        });
                      else M.toast({ html: "Error: Tamaño no válido" });
                    }}
                  >
